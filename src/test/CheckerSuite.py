...
class CheckerSuite(unittest.TestCase):
    ...
    main: function auto(){}
    """
        expect = "Type mismatch in Variable Declaration: VarDecl(a, IntegerType, StringLit(lmao))"
    ...
    c: string = a;
    """
        expect = "Type mismatch in Variable Declaration: VarDecl(c, StringType, Id(a))"
    ...
    a: string = foo(a, a);
    """
        expect = "Type mismatch in expression: FuncCall(foo, [Id(a), Id(a)])"
    ...
    """
        expect = "Type mismatch in expression: BinExpr(==, IntegerLit(0), FloatLit(0.0))"
    ...
    """
        expect = "Type mismatch in statement: ForStmt(AssignStmt(Id(a), IntegerLit(1)), BinExpr(<, Id(a), IntegerLit(10)), BinExpr(+, Id(a), FloatLit(1.1)), ReturnStmt())"
    ...
    """
        expect = "Type mismatch in expression: BinExpr(==, Id(a), FloatLit(1.1))"
    ...
    """
        expect = "Type mismatch in statement: ForStmt(AssignStmt(Id(a), IntegerLit(1)), FuncCall(bar, []), FuncCall(goo, []), ReturnStmt())"
