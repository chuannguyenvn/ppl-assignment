...
public class MPParser extends Parser {
	...
	public static class VardeclsContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MPVisitor ) return ((MPVisitor<? extends T>)visitor).visitVardecls(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class VardecltailContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MPVisitor ) return ((MPVisitor<? extends T>)visitor).visitVardecltail(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MptypeContext extends ParserRuleContext {
		...
		public TerminalNode FLOATTYPE() { return getToken(MPParser.FLOATTYPE, 0); }
	...
	public static class IdsContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MPVisitor ) return ((MPVisitor<? extends T>)visitor).visitIds(this);
			else return visitor.visitChildren(this);
		}
	}
